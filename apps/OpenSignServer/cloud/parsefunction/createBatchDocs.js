  ...
  for (let i = 0; i < signerMail.length; i++) {
    try {
      ...
      let params = {
        ...
        subject: `${document.ExtUserPtr.Name} le ha pedido que firme "${document.Name}"`,
        mailProvider: document?.ExtUserPtr?.active_mail_adapter || '',
        from: sender,
        html:
        ...
        ' te ha solicitado revisar y firmar <strong> ' +
        document.Name +
